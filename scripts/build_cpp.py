...
os.system("g++ -g "+" ".join(object_files)+" -o bin/SimmerEngineLib.exe")
os.system("g++ -g "+" ".join(object_files)+" -o src/lib/SimmerEngineLib.dll")
os.system("g++ -g "+" ".join(object_files)+" -o src/lib/SimmerEngineLib_UNIX.so")
